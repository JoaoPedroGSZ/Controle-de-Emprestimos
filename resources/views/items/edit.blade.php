...
<head>
    ...
    <title>Editar Item - Controle de Empréstimos</title>
...
<body>
    <div class="container">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h3 class="fw-bold m-0">Editar Item: #{{ $item->id }}</h3>
        ...
        <div class="card custom-card-form mx-auto" style="max-width: 600px;">
            ...
            <form action="{{ route('items.update', $item->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="descricao" id="descricao" class="form-control" rows="3" required>{{ old('descricao', $item->descricao) }}</textarea>
                </div>
                ...
                <div class="d-grid gap-2">
                    <button type="submit" class="btn btn-primary btn-lg fw-bold">Atualizar Item</button>
                </div>
            </form>
        </div>
    </div>
